...
public class StringCalculate {
    ...
    private static final int DEF_DIV_SCALE = 16;// 默认除法运算精度
...
//        return result;
    ...
    public static double calculate(String expression) {
        ...
        while (!postfixStack.isEmpty()) {
            ...
            if (!isOperator(currentValue.charAt(0))) {// 如果不是运算符则存入操作数栈中
                ...
                String tempResult = calc(firstValue, secondValue, currentValue.charAt(0));
    ...
    private static void prepare(String expression) {
        ...
        for (int i = 0; i < arr.length; i++) {
            ...
            if (isOperator(currentOp)) {// 如果当前字符是运算符
                ...
                peekOp = opStack.peek();
                /*if (currentOp == ']') {// 遇到反中括号则将运算符栈中的元素移除到后缀式栈中直到遇到左中括号
                	while (opStack.peek() != '[') {
     ...
     * @return
     */
    private static String calc(String firstValue, String secondValue, char currentOp) {
        String result = "";
        switch (currentOp) {
        case '+':
        ...
        case '/':
            ...
            break;
        case '%':
        	result = String.valueOf(mod(firstValue, secondValue));
            break;
        }
        return result;
    }
    ...
    public static double mod(String v1, String v2) {
        java.math.BigDecimal b1 = new java.math.BigDecimal(v1);
        java.math.BigDecimal b2 = new java.math.BigDecimal(v2);
        java.math.BigDecimal[] results = b1.divideAndRemainder(b2);
        return results[1].doubleValue();
    }

	public static void main(String[] args) {
		String result = conversion(args[0]);
